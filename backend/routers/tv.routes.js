...
router.get("/:id/trailers",(req,res)=>getTrailers(req,res,"tv"))
router.get("/:id/details",(req,res)=>getDetails(req,res,"tv"))
router.get("/:id/similar",(req,res)=>getSimilar(req,res,"tv"))
